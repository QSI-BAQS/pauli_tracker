...
pub type Map_pdfx = Map<PauliDense, BuildHasherDefault<FxHasher>>;
...
pub type MappedVector_pdfx = MappedVector<PauliDense, BuildHasherDefault<FxHasher>>;
...
pub type BufferedVector_pd = BufferedVector<PauliDense>;
...
boilerplate!(
    ...
    (MappedVector_pdfx, mapped_vector_pdfx_, PauliDense),
    ...
    (BufferedVector_pd, buffered_vector_pd_, PauliDense),
...
pub type RawVec_pd = RawVec<PauliDense>;
...
impl_api::raw_vec_newtyped!(BufferedVector_pd, buffered_vector_pd_, RawVec_pd);
